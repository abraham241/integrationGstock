      ...
      <div className='w-full'>
        ...
        <div className='w-full flex flex-col justify-items-center bg-slate-100 pb-[5%] '>
          ...
          <div className='mt-4 w-[98%] ml-[-0.8%]'>
            <form className="rounded-md p-[3%] pb-[4%] bg-white ml-10">
              ...
              <div className="flex items-center justify-center w-[85%] h-[10%] mb-[10%] ">
                <label for="countries" className="w-[50%] mt-[-34%] block mb-2 text-sm font-medium text-gray-900 dark:text-white">Image de l’article</label>
              ...
              <div className="mt-[-6%] flex">
                <label for="email" className=" w-[30%] block  text-sm font-medium text-gray-900 dark:text-white">Code de l’article</label>
                <input type="email" id="email" className="ml-[-2%] bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-[57%] p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
              </div>
              <div className="mt-[3%] flex">
                <label for="email" className=" w-[30%] block  text-sm font-medium text-gray-900 dark:text-white">Code de la famille</label>
                <input type="email" id="email" className="ml-[-2%] bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-[57%] p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
              </div>
              <div className="mt-[3%] flex">
                <label for="email" className=" w-[30%] block  text-sm font-medium text-gray-900 dark:text-white">Prix</label>
                <input type="name" id="email" className="ml-[-2%] bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-[57%] p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
              </div>
              <div className="mt-[3%] flex">
          ...
          <div className='mt-5 flex justify-end px-6 pt-[3%] '>
            <button type="button" className="focus:outline-none text-white w-32 bg-[#FF5202] hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">Annuler</button>
            <button type="button" className="focus:outline-none text-white w-52 bg-[#FFCF02] hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:focus:ring-yellow-900">Ajouter une famille</button>
          </div>
